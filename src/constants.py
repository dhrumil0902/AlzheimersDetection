...
OVERLAP_RATIO = 0.75
OVERLAP_LENGTH_SECONDS = SEGMENT_LENGTH_SECONDS * OVERLAP_RATIO
OVERLAP_LENGTH_SAMPLES = OVERLAP_LENGTH_SECONDS * SAMPLING_FREQUENCY
STEP_LENGTH_SECONDS = SEGMENT_LENGTH_SECONDS - OVERLAP_LENGTH_SECONDS
STEP_LENGTH_SAMPLES = int(SEGMENT_LENGTH_SAMPLES - OVERLAP_LENGTH_SAMPLES)

#N_SEGMENTS = int(EPOCH_LENGTH_SECONDS / SEGMENT_LENGTH_SECONDS)
N_SEGMENTS = int((EPOCH_LENGTH_SECONDS - OVERLAP_LENGTH_SECONDS) / STEP_LENGTH_SECONDS)
assert(N_SEGMENTS == 21);
